 ...
 */
?>
<div id="edit-date-range-dropdown1" class="date-range-container">
  <label>
  <?php print t('Choose a time period'); ?>
  <span class="form-required" title="This field is required.">*</span>
  </label>
  <a href="#" id="date-selected1" class="report-dropdown-toggle"><?php print $date_display; ?></a>
  <div id="date-range-dropdown1" class="report-dropdown hide">
    <ul>
