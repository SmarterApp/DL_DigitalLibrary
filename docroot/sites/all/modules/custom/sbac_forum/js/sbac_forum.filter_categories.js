(function ($) {
  ...
  Drupal.behaviors.sbac_forum_js_filter_categories = {
    attach: function (context, settings) {
      ...
      $('#sbac-forum-filter-button').click(function() {
      ...
      $('.sbac-forum-filter-name').click( function (e) {
      ...
      $('#sbac-forum-cat-button').click( function () {
      ...
      $('#sbac-forum-close-button').click( function () {
        close_categories_list();
        $('.selectedDiv').hide();
        return false;
      });
